...
public:
   ...
   void publishReturn(const std::string &command,
                      const std::string &message);
   void publishInfo(const std::string &command,
                    const std::string &message);
   void publishWarning(const std::string &command,
                       const std::string &message);
   void publishError(const std::string &command,
                     const std::string &message);
